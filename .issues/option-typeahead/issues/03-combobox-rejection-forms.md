...
The rejection add/edit forms (`app/log/rejection-row.tsx`) now use the shared
`OptionCombobox`. The edit-a-dinner picker's conversion is the scope of issue
02; the final rollout criterion holds once 01, 02, and 03 are all integrated —
this branch delivers the rejection-form slice and is verified green against
the integration tip carrying issue 01.
